...
2. Are the following definitions valid? Why or why not?
	...
	A. You're setting it in the declaration then never changing it, so this is fine.
...
int main() {
	...
	A. This works.  The { } keep it seperate
...
int main()
{
	...
	A. Both work, but I'm not sure why.  It looks like you defined it twice.
...
int main()
{
	...
	A: This should still work.  Strings can contrain white space.  You're just overwriting the name variable.
